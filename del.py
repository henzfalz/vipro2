...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EsugDQLGzv7TL4lWYgV2.NxEOVDpjUSPBaUe9qLZXqG.KYaMRzh21NFYLar1vQ9qUHwICIALlMZK5zX/1Sli8e0=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtH1uB13nnSR04MRX4Dc.Rn29fH0iyRm8c4OOYliz3a.R7mbqRZH4lzc1Zn6RMbNWLxbx6pX79EXpCEXvvjjqAA=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EtSxwQI0HqxWJtk2RMP0.QYde7oALGh7T4SLLcFpgya.yzd82zMLPgJhGwKrTuSzvf/gG8Ofj8PB2pLYAZc6GLE=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EtPFSSuEW7j3mTv0Taz8.fcoMlPFAcKPyUFmdtX0GUa./+LsceKS1L/lPSMBCF8djENd/bYZkUjqbJck58rGYhI=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtIco8cmJkDFUaxMOcRe.OsDm6NYv3cmsoFtaIjy2tG.TaPRAaBiU1p2Ak4DEatGS8232EhiuEFzSSSlLuE+EFE=')
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EtXatEg9Lh5uXzbjxO49.tJMxRtazVZT1pqzL9twcUq.zrOmQTlSO1jKh8Svmi7t0zkLYPADJ+2MJ2QHToOv66A=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtoVsEoE3RzA8goo4o59.9bQwpKLmr2D7kxzgXdpQ2q.ItO2G8eR4tJl1M3ZQpEj6JLP6ECn6AxEPmkO1grclTk=')
km.loginResult()
...
╠➩〘Responkick on/off〙
╠➩〘Leave on/off〙
╠➩〘All join / (FadeL1/2/3/4 Join)〙
"""

helpMessage ="""💫☠️ғᴀʟʟᴮᴼᵀ☠️💫
☠️✨[ˢᴹᵁᴸᴱ ᴼᶠ ˢᴵᴺᴳ ᵀᴼᴳᴱᵀᴴᴱᴿ]✨☠️
☠️➩ᴷᴱᵞᴘʀᴏᴛᴇᴄᴛ
☠️➩ᴷᴱᵞsᴇʟғ
☠️➩ᴷᴱᵞʙᴏᴛ
☠️➩ᴷᴱᵞɢʀᴏᴜᴘ
...
protectMessage ="""☠️ғᴀʟʟ-protect☠️
☠️➩ᴀʟʟᴘʀᴏᴛᴇᴄᴛ ᴏɴ/ᴏғғ
☠️➩ᴀᴜᴛᴏᴄᴀɴᴄᴇʟ ᴏɴ/ᴏғғ
☠️➩ǫʀ ᴏɴ/ᴏғғ
☠️➩ᴀᴜᴛᴏᴋɪᴄᴋ ᴏɴ/ᴏғғ
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,vipro]
Creator=["u530b8459bbe36cc0652f7f976d9d917c"]
admin=["u530b8459bbe36cc0652f7f976d9d917c"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Fadel")
	    ...
	    elif msg.text in ["Della on"]:
	     if msg.from_ in admin:	        
                wait["Ghost"] = True
                cl.sendText(msg.to,"ᴅᴇʟʟᴀ sᴜᴅᴀʜ ᴀᴋᴛɪғ")
	     else:
		    cl.sendText(msg.to,"Khusus Fadel")		

	    elif msg.text in ["Della off"]:
	     if msg.from_ in admin:	        
                wait["Ghost"] = False
                cl.sendText(msg.to,"ᴅᴇʟʟᴀ sᴜᴅᴀʜ ᴅɪ ɴᴏɴᴀᴋᴛɪғᴋᴀɴ")
	     else:
		    cl.sendText(msg.to,"Khusus Fadel")	     
...
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus Fadel")
                ...
                if wait["Sambutan"] == False:
                    ...
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"sᴜᴅᴀʜ ᴏғғ (p′︵‵。)")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"sɪᴀᴘ ᴏɴ ᴄᴇᴋ sɪᴅᴇʀ")
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["All join","Joinall","Come"]:
		if msg.from_ in admin:
		...
		cl.sendText(msg.to,"ғᴀʟ&ᴅᴇʟ Absen!!")
                ki.sendText(msg.to,"ғᴀᴅᴇʟ1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"ғᴀᴅᴇʟ2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"ғᴀᴅᴇʟ3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua BosQ  \(ˆ▿ˆ)/")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "ᴋʜᴜsᴜs ғᴀʟʟᴀʜ")
              ...
              if msg.from_ in Creator:
               ...
               if msg.from_ in admin:
            	...
            	if msg.from_ in admin:
                    ...
                    beb = "Hi ƒαʍίʆψ Ƙմ 😘 ","հαʆʆσ յɡ 😀" +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
		...
		if msg.from_ in Creator:
              ...
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"Sodok")
                kk.sendText(msg.to,"Tak tun tuang")
                kc.sendText(msg.to,"Tapi masih cantik juga")
                kr.sendText(msg.to,"Sikat")
                cl.sendText(msg.to,"Goyang senggol")
                ...
                kc.sendText(msg.to,"Ramaikan")
                kr.sendText(msg.to,"Goyang")
                cl.sendText(msg.to,"Tapi kalau langsuang diidu")
                ki.sendText(msg.to,"Tak gendong yuk")
            ...
            elif msg.text in ["Fadel1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Fadel2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Fadel3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["Fadel4 acc invite"]:
                if msg.from_ in admin:
